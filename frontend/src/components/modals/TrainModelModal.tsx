        ...
        <form onSubmit={handleUpload} className="py-5 space-y-4">
          ...
          <label className="block">
            ...
            <select
              ...
              className="w-full rounded-lg px-3.5 py-2.5 text-sm bg-[#0d1117] border border-[#30363d] focus:border-[#388bfd] focus:outline-none transition-colors appearance-none"
              style={{
          ...
          <div
            ...
            className="border-2 border-dashed border-[#30363d] hover:border-[#388bfd] rounded-2xl p-6 text-center cursor-pointer transition-all duration-200 bg-[#0d1117]/50 hover:bg-[#0d1117]"
          >
            <input
              type="file"
              ref={fileInputRef}
